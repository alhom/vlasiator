...
#ifndef STATICIONOSPHERE_H
#define STATICIONOSPHERE_H
...
namespace SBC {
   ...
   struct StaticIonosphereSpeciesParameters {
      Real rho;
      Real V0[3];
      Real T;
      Real fluffiness;
    ...
    */
   class StaticIonosphere: public SysBoundaryCondition {
   public:
      StaticIonosphere();
      virtual ~StaticIonosphere();
   ...
   protected:
      ...
      std::vector<StaticIonosphereSpeciesParameters> speciesParams;
      Real T;
      Real rho;
      Real VX0;
      Real VY0;
